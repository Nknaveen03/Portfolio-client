...
const projects = [
  {
    ...
    description:
      'A Food delivery application with product listing, cart management, user authentication, and payment integration using the MERN stack.',
    tech: ['React', 'Node.js', 'Express', 'MongoDB', 'Tailwind CSS'],
    github: 'https://github.com/Nknaveen03/QuickBite.git',
    live: 'https://github.com/Nknaveen03/QuickBite.git',
  ...
  },
  {
    ...
    github: 'https://github.com/Nknaveen03/Portfolio-client.git',
    live: 'https://portfolio-client-puce-delta.vercel.app/',
